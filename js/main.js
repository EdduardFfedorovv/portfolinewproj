...
var arrLang = {
    'ua': {
        ...
        'about me' : 'ПРО МЕНЕ',
        'my name' : 'Привіт, мене звати Едуард. Я починаючий веб-розробник. Вирішив кардинально змінити професію і не пошкодував. Я отримую задоволення від навчання і роботи у цьому напрямку. Й надалі планую отримувати не тільки задоволення, а й дохід від справи яка мені до вподоби. Дисциплінований та цілеспрямований. Маю двох дітей та собаку-ведмедя, цікавлюсь боксом, люблю море та мрію опанувати серфінг.  ',
        'cv' : 'Завантажи CV',
        ...
        'osteo': 'Браузерна гра',
        'children': 'Дитяча гра на розвиток пам`яті',
    ...
    'en': {
        ...
        'main info' : 'main info',
        'about me' : 'ABOUT ME',
        'my name' : 'Hi, my name is Eduard, I am a beginner web developer. Decided cardinally to change a profession and did not feel sorry. I enjoy studies and work in this direction. In the future, I plan to receive not only pleasure, but also income from a business that I like. Disciplined and purposeful. Have two children and dog-bear, interested in boxing, love a sea and dream to capture surfing.',
        'cv' : 'Download CV',
        'works' : 'latest works',
        'all' : 'All',
        ...
        'osteo': 'business card website',
        'children': 'Children`s game for memory development',
        'proj2' : 'view-project',
